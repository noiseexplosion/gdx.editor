...
public class SetupUtils
{
	...
	public static class EnvironmentFactory
	{
		...
		public static SceneManager quickSceneManagerSetup(Logger log, boolean printLog)
		{
		...
		public static void createEnv(PerspectiveCamera camera, SceneManager sceneManager, DirectionalShadowLight light, Logger log, boolean printLog) {
			Color   ambientLightColor = ModelUtils.getRandomColor();
			...
			light.color.set(ModelUtils.getRandomColor());
			light.intensity=10f;
